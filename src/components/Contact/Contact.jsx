		...
		<div className="py-6 md:py-0 md:px-6  md:text-l space-y-3">
			...
			<div className="space-y-4">
				...
				<p className="flex gap-5 items-center text-2xl">
					...
					<span className="text-base sm:text-xl text-green-700 font-semibold">jahedmunna612@gmail.com</span>
				</p>
                <p className="flex gap-5 items-center text-2xl">
				   <span className="text-slate-700"><FaPhoneFlip/></span>
					<span className="text-base sm:text-xl text-sky-700 font-semibold">+8801795500756</span>
				</p>
                <p className="flex gap-5 items-center text-2xl">
					<span className="text-slate-700"><FaHouse/></span>
					<span  className="text-base sm:text-xl text-violet-600 font-semibold">Sylhet,Bangladesh</span>
				</p>
			</div>
		</div>
